...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: {
        "2xl": "var(--radius-lg)",   /* 16px — large cards */
        xl: "var(--radius)",          /* 12px — buttons, modals */
        lg: "var(--radius)",
        md: "var(--radius-sm)",       /* 8px — inputs, small elements */
      ...
      animation: {
        ...
        "spring-in": "spring-in 300ms cubic-bezier(0.2, 0, 0, 1) forwards",
      },
    },
  },
